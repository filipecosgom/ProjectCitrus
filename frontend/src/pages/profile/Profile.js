    ...
    <div className="user-profile">
      ...
      <div className="profile-tabs-row">
        <div className="tabs">
          ...
          <button
            className={`tab${activeTab === "appraisals" ? " active" : ""}`}
      ...
      {/* Cards à esquerda (ou em cima no mobile) */}
      <div className="profile-header">
        ...
        <div className="manager-card">
          <div className="manager-card-title">Manager</div>
          <div className="manager-card-content">
            ...
            <div className="manager-info">
              ...
              <div className="manager-email">{user.manager?.email}</div>
            </div>
          </div>
        </div>
      </div>

      {/* Formulário à direita (ou em baixo no mobile) */}
