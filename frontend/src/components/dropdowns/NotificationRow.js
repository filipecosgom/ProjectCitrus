...
/**
 * @file NotificationRow.js
 * @module NotificationRow
 * @description NotificationRow styled like NotificationDropdown, with selection support.
 * @author Project Citrus Team
 */

/**
 * NotificationRow component for displaying a notification with selection support.
 ...
 * @param {boolean} props.isSelected - Whether the notification is selected
 * @returns {JSX.Element}
 */
export default function NotificationRow({
  ...
  /**
   * Handles checkbox change for notification selection.
  ...
  return (
    ...
    >
      ...
      <div className="notificationRow-iconAndSender-cell">
        <div className="notificationRow-icon-cell">{icon}</div>
        <div className="notificationRow-sender">{senderName}</div>
      </div>
      <div
