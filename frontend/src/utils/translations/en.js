...
const en = {
  ...
  twoFactorWhatIsDescription: "Two-factor authentication adds an extra layer of security to your account. After entering your password, you'll need to enter a 6-digit code generated by an authenticator app on your phone.",
  twoFactorSetupTitle: "How to Set Up 2FA",
  twoFactorSetupStep1: "Open Google Authenticator, Microsoft Authenticator, or Authy.",
  twoFactorSetupStep2: "Tap 'Add a new account' and choose 'Manual Entry'.",
  twoFactorSetupStep3: "Enter the secret key below:",
  twoFactorSetupStep4: "Save the setup, and the app will start generating codes every 30 seconds.",
  twoFactorSecretPlaceholder: "SECRET-KEY",
  twoFactorLoginTitle: "Logging In with 2FA",
  twoFactorLoginDescription: "Whenever you log in, enter the latest 6-digit code shown in your authenticator app. The code changes every 30 seconds, so make sure to use the most recent one.",
